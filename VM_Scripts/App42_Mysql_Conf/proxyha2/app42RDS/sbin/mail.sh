...
mutt -s "$setup_name App42RDS Mysql Failover = New Master - 10.20.1.8" $Email -a /var/log/masterha/master-mysql/master-mysql.log < /var/log/masterha/master-mysql/master-mysql.log
