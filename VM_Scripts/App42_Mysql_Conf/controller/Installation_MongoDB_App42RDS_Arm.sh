...
if [ $? -eq 0 ]; then
	parallelshell "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$proxy1 '/home/azureuser/git/bin/git clone https://github.com/abc/Installationpkg.git'" "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$proxy2 '/home/azureuser/git/bin/git clone https://github.com/abc/Installationpkg.git'" "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$mongodb1 '/home/azureuser/git/bin/git clone https://github.com/abc/Installationpkg.git'" "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$mongodb2 '/home/azureuser/git/bin/git clone https://github.com/abc/Installationpkg.git'"
        if [ $? -eq 0 ]; then
                parallelshell "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$mongodb1 'sudo /home/azureuser/Installationpkg/mongoha1/settingup qscguk. $mongodb_conn'" "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$mongodb2 'sudo /home/azureuser/Installationpkg/mongoha2/settingup qscguk. $mongodb_conn'" "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$proxy1 'sudo /home/azureuser/Installationpkg/mongoproxyha1/settingup qscguk.'" "ssh -i /var/keys/app42rds_key -p 22 -tt azureuser@$proxy2 'sudo /home/azureuser/Installationpkg/mongoproxyha2/settingup qscguk.'"
		if [ $? -eq 0 ]; then
			counter=11
