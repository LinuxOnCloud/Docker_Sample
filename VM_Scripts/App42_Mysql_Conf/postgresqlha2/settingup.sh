...
if [ $? -eq 0 ]; then
sleep 60
sudo yum install -y /home/azureuser/Installationpkg/comman/rpms/core/bash* /home/azureuser/Installationpkg/comman/rpms/utility/fsarchiver* /home/azureuser/Installationpkg/comman/rpms/utility/mutt* /home/azureuser/Installationpkg/comman/rpms/utility/nc* /home/azureuser/Installationpkg/comman/rpms/utility/tokyocabinet* /home/azureuser/Installationpkg/comman/rpms/utility/urlview* http://yum.postgresql.org/9.6/redhat/rhel-7-x86_64/pgdg-centos96-9.6-3.noarch.rpm
if [ $? -eq 0 ]; then
...
#sudo apt-get install -y --force-yes postgresql-9.6 postgresql-client-9.6 postgresql-9.6-repmgr
	...
	sleep 60
	sudo yum install -y /home/azureuser/Installationpkg/comman/rpms/utility/postgresql96-9.6.6-1PGDG.rhel6.x86_64.rpm /home/azureuser/Installationpkg/comman/rpms/utility/postgresql96-contrib-9.6.6-1PGDG.rhel6.x86_64.rpm /home/azureuser/Installationpkg/comman/rpms/utility/postgresql96-libs-9.6.6-1PGDG.rhel6.x86_64.rpm /home/azureuser/Installationpkg/comman/rpms/utility/postgresql96-server-9.6.6-1PGDG.rhel6.x86_64.rpm /home/azureuser/Installationpkg/comman/rpms/utility/repmgr96-3.3.2-1.rhel6.x86_64.rpm
	...
	if [ $? -eq 0 ]; then
		...
		sudo cp -arf /home/azureuser/Installationpkg/comman-postgresql/repmgr-standby.conf /etc/repmgr/repmgr.conf
