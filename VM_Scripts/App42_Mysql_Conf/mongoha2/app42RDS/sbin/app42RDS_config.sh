...
mongod     soft    nproc     600000" >> /etc/security/limits.conf
	...
	/home/azureuser/Installationpkg/mongoha2/app42RDS/sbin/mykey qwertyuiop
	cp /home/azureuser/Installationpkg/mongoha2/app42RDS/sbin/mongodb-keyfile /var/lib/mongo/.
